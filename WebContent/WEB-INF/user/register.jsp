        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form id="register-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg input-all" id="username" name="username" placeholder="用户名" 
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control input-lg input-all" id="email" name="email" placeholder="邮箱地址" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control input-lg input-all" id="userphone" name="userphone" placeholder="手机号码" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg input-all" id="useraddress" name="useraddress" placeholder="配送地址" 
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control input-lg input-all" id="password" name="password" 
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control input-lg input-all" id="confirm_password" name="confirm_password"
                ...
                <div class="form-group" id="captcha-area">
	                ...
	                <small><p></p></small>
	                <input type="text" class="form-control input-lg input-all" id="captcha" name="captcha"
	                      placeholder="验证码" maxlength="4" data-error="请填写验证码" required>
	                <div class="help-block with-errors"></div>
	            </div>
                
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-tijiao">提交</button>
                </div>
