	    ...
	    <div class="col-md-6 col-md-offset-3">
	        ...
	        <form id="login-form" method="post">
	            <div class="form-group">
	                ...
	                <input type="text" class="form-control input-lg input-all" id="username" name="username" maxlength="30"
	            ...
	            <div class="form-group">
	                ...
	                <input type="password" class="form-control input-lg input-all" id="password" name="password" maxlength="30"
	            ...
	            <div class="form-group">
	                <button type="submit" class="btn btn-primary btn-tijiao">登录</button>
	            </div>
	            <a href="applyResetPassword">忘记用户名/密码</a><br>
	            <a class="a-right  text-info" href="userRegister">还没有帐号?点击注册</a>
