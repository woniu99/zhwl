...
<body>
	...
	<div class="image-slider">
		...
		<ul class="rslides" id="slider">
			<li><img src="image/banner/index04.jpg" alt="">
			</li>
			<li><img src="image/banner/index07.jpg" alt="">
			</li>
			<li><img src="image/banner/index08.jpg" alt="">
			</li>
			<li><img src="image/banner/index09.jpg" alt="">
			</li>
		</ul>
		<!-- Slideshow 2 -->
	</div>
