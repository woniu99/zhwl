	            ...
	            <div class="sidebar-nav">
	                <div class="nav-canvas">
	                    ...
	                    <ul class="nav nav-pills nav-stacked main-menu">
	                        ...
	                        <li><a class="ajax-link" id="userInfo" href="adminPage">
	                        ...
	                        <li class="accordion">
	                            <a href="#"><i class="glyphicon glyphicon-globe"></i><span> 车辆管理</span></a>
	    ...
	    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
		    ...
		    <s:iterator value="#session.userLists">
			    <tr>
			        ...
			        <td class="center">
			            <a class="btn btn-info editUser" href="#">
						...
						<input type="hidden" class="username" value="${ user_name }"/>
