...
<body onload="init()">
	...
	<div class="wrap" align="center">
		<div style="display:none" >
			<video   width="800px" id="sourcevid" controls   autoplay loop >
				<source  src="video/zbdx.mp4" type="video/mp4"/>

			</video>
			<canvas id="sourcecopy" width="1000" height="600"></canvas>
		</div>
     </div>
     <div class="container">
	...
	<div id="content" style="width:1000px; margin:0 auto; font-size:16px">
